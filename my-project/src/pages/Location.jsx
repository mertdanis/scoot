  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="relative">
        ...
        <LocationCard className={`top-[18px] left-[393px]`}></LocationCard>

        <LocationCard className={`top-[78px] right-[65px]`}></LocationCard>

        <LocationCard className={`bottom-[203px] right-[142px]`}></LocationCard>
      </div>
